package com.imhub.messaging.constants;
...
public enum ConfigEnum {
    ...
    IMAGE_URI("imageUri","http://127.0.0.1:9000/imhub/avatar/"),
    MEDIA_TYPE("mediaType","application/json; charset=utf-8"),
    MSG_URL("msgUrl","/api/v1/message/user/"),
    KAFKA_TOPICS("kafkaTopics","imhub_message"),
