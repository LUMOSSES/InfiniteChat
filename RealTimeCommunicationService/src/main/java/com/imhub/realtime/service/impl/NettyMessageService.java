...
import com.imhub.realtime.constants.MessageRcvTypeEnum;
import com.imhub.realtime.constants.PushTypeEnum;
...
import com.imhub.realtime.excption.ServiceException;
import com.imhub.realtime.model.*;
...
public class NettyMessageService {
    ...
    private void copyLongFields(ReceiveMessageRequest src, com.imhub.realtime.model.Message dest) {
